...
class BiboMart:
    ...
    def get_category_list(self):
        ...
        # Get categories
        categories_bar = toppage_soup.find_all(
            "li", class_="menu megamenu-item has-child has-content"
        )
        ...
        for cat in categories_bar:
            ...
            for child in child_cats:
                ...
                try:
                    grandchild_cats = child_soup.find("ul", class_="cate-2").find_all(
                        "li"
                    )
